...
def test_refresh_response_matches_declared_schema() -> None:
    fake = FakePool()
    ...
    try:
        TokenWithRefresh.model_validate(resp)
    except ValidationError as exc:
        raise AssertionError(f"/refresh response did not match TokenWithRefresh: {exc}")
